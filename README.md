...
edit /usr/local/lib/python3.8/dist-packages/ryu/app/wsgi.py
search for ALREADY_HANDLED.
Change the line: from eventlet.wsgi import ALREADY_HANDLED to: ALREADY_HANDLED = object()
...
Screenshot 2
 Mininet tree topology (depth=2, fanout=2) started

mininet> net
mininet> dump

Screenshot 3
 Topology with 4 hosts and 3 switches
...
Screenshot 4
 Normal unicast traffic and selective forwarding rules on s2
...
Screenshot 5
 Flow tables showing priority 1 rules
...
Screenshot 6
 Flow rules installed on core switch s1

Step 4: iperf baseline
mininet> iperf h1 h2

Screenshot 7
 iperf baseline throughput
...
Screenshot 8
 Broadcast storm detected and dropped by controller

Step 6: Legitimate traffic after storm
mininet> h1 ping -c 5 h2

Screenshot 9
 Normal traffic unaffected after broadcast storm

Step 7: iperf after storm
mininet> iperf h1 h2

Screenshot 10
 iperf throughput maintained after storm

Step 8: Full connectivity test
mininet> pingall

Screenshot 11
 Full connectivity with no packet loss
...
Screenshot 13
 Flows reinstalled by controller
...
Screenshot 15
 Broadcast storm entries showing forwarded and dropped packets
----------------------------------------------------------------------------------------------------
Proof of execution:
